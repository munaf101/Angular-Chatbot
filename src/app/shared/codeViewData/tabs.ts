    ...
    <div class="tab-menu-heading">
        <div class="tabs-menu ">
            ...
            <ul ngbNav #nav3="ngbNav" [(activeId)]="TabStyle3" class="nav">
                <li [ngbNavItem]="1"><a ngbNavLink><i class="fe fe-airplay me-1"></i> Tab Style 01</a>
                    <ng-template ngbNavContent>
                ...
                <li [ngbNavItem]="2"><a ngbNavLink><i class="fe fe-package me-1"></i> Tab Style 02</a>
                    <ng-template ngbNavContent>
                ...
                <li [ngbNavItem]="3"><a ngbNavLink><i class="fe fe-settings me-1"></i> Tab Style 03</a>
                    <ng-template ngbNavContent>
                ...
                <li [ngbNavItem]="4"><a ngbNavLink><i class="fe fe-database me-1"></i> Tab Style 04</a>
                    <ng-template ngbNavContent>
