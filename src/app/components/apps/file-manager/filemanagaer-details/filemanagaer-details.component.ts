...
@Component({
  selector: 'app-filemanagaer-details',
  templateUrl: './filemanagaer-details.component.html',
  styleUrls: ['./filemanagaer-details.component.scss']
})
export class FilemanagaerDetailsComponent {
  ...
  imagesRect: Image[] = [
     ...
     new Image(1, {img: "./assets/images/photos/20.jpg" }, {img: "./assets/images/photos/20.jpg"}),
     new Image( 2, { img: "./assets/images/media/11.jpg" },{img: "./assets/images/media/11.jpg"} ),
     new Image( 3, {img:"./assets/images/media/12.jpg",  }, {img: "./assets/images/media/12.jpg"} ),
